class LecturerScheduleManager {
  ...
  setupEventListeners () {
    ...
    if (menuToggle && sideMenu) {
      // Toggle the visibility when clicking the burger icon
      menuToggle.addEventListener('click', (e) => {
        e.stopPropagation() // Stops the click event bubbling up to document listener below
        sideMenu.classList.toggle('hidden')
      })

      // Clean click-away layout closer
